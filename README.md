...
### 🎯 Смещение клика
- Настройка смещения координат клика по осям X и Y
- Позволяет обойти системные блокировки, которые могут игнорировать клик в точную найденную координату
...
Этот проект создан в образовательных целях.�оект создан в образовательных целях.